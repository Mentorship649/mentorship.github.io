    ...
    <div class="card-body login-card-body">
      ...
      <form action="studentquery.php" method="POST">
        <div class="input-group mb-3">
          <input type="text" name="enrollment" class="form-control" placeholder="Username/Enrollment" required>
        ...
        <div class="col">
		  ...
		  <div class="col-12">
		   ...
		   <div class="col-12">
		   <br/>
		   &emsp;<a href="../" class="small-box-footer">Back To Home </a>&emsp;&emsp;&emsp;<a href="beforeforgotepassword.php" class="small-box-footer">Forgote password? </a>
            </div> 
          <!-- /.col -->
        </div>
      </form>
