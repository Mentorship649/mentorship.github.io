        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Change Mentor</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
				...
				<form action="" method="post">
					...
					<div class="col-md-2">
						<div class="form-group">
							...
							<form action="changementorquery.php" method="post">
				...
				<div class="col-lg-12">
					...
					<table class="table-responsive table table-hover">
						...
						if(isset($_POST['go']))
						{
										...
										if($batch)
										{
											$sel = "select * from studentreg where batch='$batch' ORDER BY `enrollment` ASC";							
										}
													
										else
										{
											$sel = "select * from studentreg ORDER BY `enrollment` ASC";
										}
						...
						?>
							...
							<tr>
								...
								<td><input type="text" value="<?php echo $row['mentor'] ?>" name="oldenrollment-temp[]" class="form-control" disabled="disabled"/>
								<td>
								<select class='form-control' name="newenrollment[]">
								<option value="<?php echo $row['mentor'] ?>">select</option>
									<?php 
