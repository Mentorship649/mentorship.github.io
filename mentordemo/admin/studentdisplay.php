                  ...
                  <tr>
                    <?php
						...
						?>
							...
							<td><a onClick="javascript: return confirm('Are you sure ? You want to DELETE Student !!  ');" href="deletestudentquery.php?enrollment=<?php echo $row['enrollment'];?>">Delete</a></td>
						</tr>
						<?php
							}
						?>			  
